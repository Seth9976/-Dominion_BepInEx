...
namespace Il2CppSystem.Collections.Generic
{
	...
	{
		// Token: 0x06004695 RID: 18069 RVA: 0x00144174 File Offset: 0x00142374
		...
		static EnumEqualityComparer()
		{
			...
			EnumEqualityComparer<T>.NativeMethodInfoPtr_Equals_Public_Virtual_Boolean_T_T_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EnumEqualityComparer<T>>.NativeClassPtr, 100673758);
			EnumEqualityComparer<T>.NativeMethodInfoPtr_GetHashCode_Public_Virtual_Int32_T_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EnumEqualityComparer<T>>.NativeClassPtr, 100673759);
			EnumEqualityComparer<T>.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EnumEqualityComparer<T>>.NativeClassPtr, 100673760);
			EnumEqualityComparer<T>.NativeMethodInfoPtr__ctor_Protected_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EnumEqualityComparer<T>>.NativeClassPtr, 100673761);
			EnumEqualityComparer<T>.NativeMethodInfoPtr_GetObjectData_Public_Virtual_Final_New_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EnumEqualityComparer<T>>.NativeClassPtr, 100673762);
			EnumEqualityComparer<T>.NativeMethodInfoPtr_Equals_Public_Virtual_Boolean_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EnumEqualityComparer<T>>.NativeClassPtr, 100673763);
			EnumEqualityComparer<T>.NativeMethodInfoPtr_GetHashCode_Public_Virtual_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EnumEqualityComparer<T>>.NativeClassPtr, 100673764);
		}

		// Token: 0x06004696 RID: 18070 RVA: 0x0014426C File Offset: 0x0014246C
		[CallerCount(0)]
		...
		// Token: 0x06004697 RID: 18071 RVA: 0x00144344 File Offset: 0x00142544
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 364011, XrefRangeEnd = 364012, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06004698 RID: 18072 RVA: 0x001443D4 File Offset: 0x001425D4
		[CallerCount(2)]
		...
		// Token: 0x06004699 RID: 18073 RVA: 0x00144410 File Offset: 0x00142610
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 364012, XrefRangeEnd = 364025, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x0600469A RID: 18074 RVA: 0x00144474 File Offset: 0x00142674
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 364025, XrefRangeEnd = 364038, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x0600469B RID: 18075 RVA: 0x001444D0 File Offset: 0x001426D0
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 364038, XrefRangeEnd = 364040, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x0600469C RID: 18076 RVA: 0x00144528 File Offset: 0x00142728
		[CallerCount(0)]
		...
		// Token: 0x0600469D RID: 18077 RVA: 0x0001ABEA File Offset: 0x00018DEA
