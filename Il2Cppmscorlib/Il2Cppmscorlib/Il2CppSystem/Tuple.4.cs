...
namespace Il2CppSystem
{
	...
	{
		// Token: 0x0600061A RID: 1562 RVA: 0x0003DA94 File Offset: 0x0003BC94
		...
		static Tuple()
		{
			...
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_get_Item1_Public_get_T1_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664288);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_get_Item2_Public_get_T2_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664289);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_get_Item3_Public_get_T3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664290);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_get_Item4_Public_get_T4_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664291);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr__ctor_Public_Void_T1_T2_T3_T4_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664292);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_Equals_Public_Virtual_Boolean_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664293);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_System_Collections_IStructuralEquatable_Equals_Private_Virtual_Final_New_Boolean_Object_IEqualityComparer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664294);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_System_IComparable_CompareTo_Private_Virtual_Final_New_Int32_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664295);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_System_Collections_IStructuralComparable_CompareTo_Private_Virtual_Final_New_Int32_Object_IComparer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664296);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_GetHashCode_Public_Virtual_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664297);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_System_Collections_IStructuralEquatable_GetHashCode_Private_Virtual_Final_New_Int32_IEqualityComparer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664298);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_ToString_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664299);
			Tuple<T1, T2, T3, T4>.NativeMethodInfoPtr_System_ITupleInternal_ToString_Private_Virtual_Final_New_String_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Tuple<T1, T2, T3, T4>>.NativeClassPtr, 100664300);
		}

		// Token: 0x17000171 RID: 369
		// (get) Token: 0x0600061B RID: 1563 RVA: 0x0003DC8C File Offset: 0x0003BE8C
		...
		// (get) Token: 0x0600061C RID: 1564 RVA: 0x0003DCC8 File Offset: 0x0003BEC8
		...
		// (get) Token: 0x0600061D RID: 1565 RVA: 0x0003DD04 File Offset: 0x0003BF04
		...
		// (get) Token: 0x0600061E RID: 1566 RVA: 0x0003DD40 File Offset: 0x0003BF40
		...
		// Token: 0x0600061F RID: 1567 RVA: 0x0003DD7C File Offset: 0x0003BF7C
		[CallerCount(1)]
		[CachedScanResults(RefRangeStart = 274862, RefRangeEnd = 274863, XrefRangeStart = 274861, XrefRangeEnd = 274862, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000620 RID: 1568 RVA: 0x0003DED8 File Offset: 0x0003C0D8
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 274863, XrefRangeEnd = 274870, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000621 RID: 1569 RVA: 0x0003DF30 File Offset: 0x0003C130
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 274870, XrefRangeEnd = 274898, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000622 RID: 1570 RVA: 0x0003DF90 File Offset: 0x0003C190
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 274898, XrefRangeEnd = 274905, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000623 RID: 1571 RVA: 0x0003DFE0 File Offset: 0x0003C1E0
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 274905, XrefRangeEnd = 274932, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000624 RID: 1572 RVA: 0x0003E040 File Offset: 0x0003C240
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 274932, XrefRangeEnd = 274968, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000625 RID: 1573 RVA: 0x0003E088 File Offset: 0x0003C288
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 274968, XrefRangeEnd = 274986, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000626 RID: 1574 RVA: 0x0003E0D8 File Offset: 0x0003C2D8
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 274986, XrefRangeEnd = 275020, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000627 RID: 1575 RVA: 0x0003E11C File Offset: 0x0003C31C
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 275020, XrefRangeEnd = 275040, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000628 RID: 1576 RVA: 0x00003F49 File Offset: 0x00002149
		...
		// (get) Token: 0x06000629 RID: 1577 RVA: 0x0003E164 File Offset: 0x0003C364
		// (set) Token: 0x0600062A RID: 1578 RVA: 0x0003E18C File Offset: 0x0003C38C
		...
		// (get) Token: 0x0600062B RID: 1579 RVA: 0x0003E234 File Offset: 0x0003C434
		// (set) Token: 0x0600062C RID: 1580 RVA: 0x0003E25C File Offset: 0x0003C45C
		...
		// (get) Token: 0x0600062D RID: 1581 RVA: 0x0003E304 File Offset: 0x0003C504
		// (set) Token: 0x0600062E RID: 1582 RVA: 0x0003E32C File Offset: 0x0003C52C
		...
		// (get) Token: 0x0600062F RID: 1583 RVA: 0x0003E3D4 File Offset: 0x0003C5D4
		// (set) Token: 0x06000630 RID: 1584 RVA: 0x0003E3FC File Offset: 0x0003C5FC
