...
namespace TMPro
{
	...
	{
		// Token: 0x060002F0 RID: 752 RVA: 0x000134EC File Offset: 0x000116EC
		...
		static TMP_Asset()
		{
			...
			TMP_Asset.NativeMethodInfoPtr_get_instanceID_Public_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TMP_Asset>.NativeClassPtr, 100663569);
			TMP_Asset.NativeMethodInfoPtr__ctor_Protected_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TMP_Asset>.NativeClassPtr, 100663570);
		}

		// Token: 0x170000FA RID: 250
		// (get) Token: 0x060002F1 RID: 753 RVA: 0x00013594 File Offset: 0x00011794
		public unsafe int instanceID
		{
			[CallerCount(12)]
			[CachedScanResults(RefRangeStart = 137589, RefRangeEnd = 137601, XrefRangeStart = 137588, XrefRangeEnd = 137589, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
			get
			{
		...
		// Token: 0x060002F2 RID: 754 RVA: 0x000135D0 File Offset: 0x000117D0
		[CallerCount(4)]
		...
		// Token: 0x060002F3 RID: 755 RVA: 0x0000375F File Offset: 0x0000195F
		...
		// (get) Token: 0x060002F4 RID: 756 RVA: 0x0001360C File Offset: 0x0001180C
		// (set) Token: 0x060002F5 RID: 757 RVA: 0x00003768 File Offset: 0x00001968
		...
		// (get) Token: 0x060002F6 RID: 758 RVA: 0x00013634 File Offset: 0x00011834
		// (set) Token: 0x060002F7 RID: 759 RVA: 0x00003783 File Offset: 0x00001983
		...
		// (get) Token: 0x060002F8 RID: 760 RVA: 0x0001365C File Offset: 0x0001185C
		// (set) Token: 0x060002F9 RID: 761 RVA: 0x0000379E File Offset: 0x0000199E
		...
		// (get) Token: 0x060002FA RID: 762 RVA: 0x0001368C File Offset: 0x0001188C
		// (set) Token: 0x060002FB RID: 763 RVA: 0x000037BD File Offset: 0x000019BD
