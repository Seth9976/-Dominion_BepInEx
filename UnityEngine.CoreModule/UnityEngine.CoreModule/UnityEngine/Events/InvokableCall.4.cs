...
namespace UnityEngine.Events
{
	...
	{
		// Token: 0x06001581 RID: 5505 RVA: 0x00051CC0 File Offset: 0x0004FEC0
		...
		static InvokableCall()
		{
			...
			InvokableCall<T1, T2, T3>.NativeMethodInfoPtr_add_Delegate_Protected_add_Void_UnityAction_3_T1_T2_T3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvokableCall<T1, T2, T3>>.NativeClassPtr, 100664884);
			InvokableCall<T1, T2, T3>.NativeMethodInfoPtr_remove_Delegate_Protected_rem_Void_UnityAction_3_T1_T2_T3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvokableCall<T1, T2, T3>>.NativeClassPtr, 100664885);
			InvokableCall<T1, T2, T3>.NativeMethodInfoPtr__ctor_Public_Void_Object_MethodInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvokableCall<T1, T2, T3>>.NativeClassPtr, 100664886);
			InvokableCall<T1, T2, T3>.NativeMethodInfoPtr__ctor_Public_Void_UnityAction_3_T1_T2_T3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvokableCall<T1, T2, T3>>.NativeClassPtr, 100664887);
			InvokableCall<T1, T2, T3>.NativeMethodInfoPtr_Invoke_Public_Virtual_Void_Il2CppReferenceArray_1_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvokableCall<T1, T2, T3>>.NativeClassPtr, 100664888);
			InvokableCall<T1, T2, T3>.NativeMethodInfoPtr_Invoke_Public_Void_T1_T2_T3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvokableCall<T1, T2, T3>>.NativeClassPtr, 100664889);
			InvokableCall<T1, T2, T3>.NativeMethodInfoPtr_Find_Public_Virtual_Boolean_Object_MethodInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvokableCall<T1, T2, T3>>.NativeClassPtr, 100664890);
		}

		// Token: 0x06001582 RID: 5506 RVA: 0x00051DF0 File Offset: 0x0004FFF0
		[CallerCount(0)]
		...
		// Token: 0x06001583 RID: 5507 RVA: 0x00051E34 File Offset: 0x00050034
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06001584 RID: 5508 RVA: 0x00051E78 File Offset: 0x00050078
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 80163, XrefRangeEnd = 80172, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06001585 RID: 5509 RVA: 0x00051ED8 File Offset: 0x000500D8
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06001586 RID: 5510 RVA: 0x00051F24 File Offset: 0x00050124
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 80172, XrefRangeEnd = 80180, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06001587 RID: 5511 RVA: 0x00051F74 File Offset: 0x00050174
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 80180, XrefRangeEnd = 80181, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06001588 RID: 5512 RVA: 0x0005207C File Offset: 0x0005027C
		[CallerCount(0)]
		...
		// Token: 0x06001589 RID: 5513 RVA: 0x0000C4A5 File Offset: 0x0000A6A5
		...
		// (get) Token: 0x0600158A RID: 5514 RVA: 0x000520E8 File Offset: 0x000502E8
		// (set) Token: 0x0600158B RID: 5515 RVA: 0x0000C4AE File Offset: 0x0000A6AE
