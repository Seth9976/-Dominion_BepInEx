...
namespace Il2CppSystem.Configuration
{
	...
	public sealed class IgnoreSection : ConfigurationSection
	{
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3752, XrefRangeEnd = 3755, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		{
			[CallerCount(0)]
			[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3755, XrefRangeEnd = 3758, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
			get
			{
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3758, XrefRangeEnd = 3761, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3761, XrefRangeEnd = 3764, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3764, XrefRangeEnd = 3767, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3767, XrefRangeEnd = 3770, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3770, XrefRangeEnd = 3773, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
