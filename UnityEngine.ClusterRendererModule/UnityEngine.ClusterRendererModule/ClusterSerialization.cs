...
namespace UnityEngine
{
	...
	public static class ClusterSerialization
	{
		...
		{
			return ClusterSerialization.SaveTimeManagerStateInternal(NativeArrayUnsafeUtility.GetUnsafePtr<byte>(buffer), buffer.Length);
		}
		...
		{
			return ClusterSerialization.RestoreTimeManagerStateInternal(NativeArrayUnsafeUtility.GetUnsafePtr<byte>(buffer), buffer.Length);
		}
		...
		{
			return ClusterSerialization.SaveInputManagerStateInternal(NativeArrayUnsafeUtility.GetUnsafePtr<byte>(buffer), buffer.Length);
		}
		...
		{
			return ClusterSerialization.RestoreInputManagerStateInternal(NativeArrayUnsafeUtility.GetUnsafePtr<byte>(buffer), buffer.Length);
		}
		...
		{
			return ClusterSerialization.SaveClusterInputStateInternal(NativeArrayUnsafeUtility.GetUnsafePtr<byte>(buffer), buffer.Length);
		}
		...
		{
			return ClusterSerialization.RestoreClusterInputStateInternal(NativeArrayUnsafeUtility.GetUnsafePtr<byte>(buffer), buffer.Length);
		}
