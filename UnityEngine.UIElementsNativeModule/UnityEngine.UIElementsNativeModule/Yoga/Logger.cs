...
namespace UnityEngine.Yoga
{
	...
	public sealed class Logger : MulticastDelegate
	{
		...
		static Logger()
		{
			Il2CppClassPointerStore<Logger>.NativeClassPtr = IL2CPP.GetIl2CppClass("UnityEngine.UIElementsNativeModule.dll", "UnityEngine.Yoga", "Logger");
		...
		// Token: 0x06000009 RID: 9 RVA: 0x00002E04 File Offset: 0x00001004
		[CallerCount(1135)]
		...
		// Token: 0x0600000A RID: 10 RVA: 0x00002E60 File Offset: 0x00001060
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 89365, XrefRangeEnd = 89383, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
